    ...
    <!-- jQuery Tags Input -->
    <script src="{{ asset('js/jquery.tagsinput/src/jquery.tagsinput.js') }}"></script>
    <!-- Switchery -->
    <script src="{{ asset('js/switchery/dist/switchery.min.js') }}"></script>
    <!-- Select2 -->
    ...
    <!-- jQuery autocomplete -->
    <script src="{{ asset('js/devbridge-autocomplete/dist/jquery.autocomplete.min.js') }}"></script>
    <!-- starrr -->
    <script src="{{ asset('js/starrr/dist/starrr.js') }}"></script>
